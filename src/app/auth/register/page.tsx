...
export default function Register() {
  ...
  return (
    <section className="flex min-h-screen w-full flex-col items-center justify-center bg-neutral-800 p-10">
      <div className="font-lora text-4xl font-bold uppercase tracking-widest text-white">Register</div>
      ...
      <form onSubmit={onSubmit} className="mt-10 flex w-full max-w-[30%] flex-col items-center justify-center gap-3">
        ...
        <button type="submit" className="btn btn-outline mt-3 w-full border-white text-white hover:bg-white hover:text-black">
          Register
        </button>

        <div className="flex w-full justify-center">
          <Link href="/auth/sign-in" className="text-sm text-white underline">
            Sign In
          </Link>
        </div>
      </form>
